    ...
    <div class="main-content" id="home">
        ...
        <header>
            <div class="container-fluid">
                ...
                <nav class="py-md-4 py-3 d-lg-flex nav_w3pvt">
                    <div id="logo">
                        <h1><a href="/"><img src="{{ URL::asset('/images/jjjbbb.png') }}" width="200" height="100" class="d-block ml-auto"></img></a></h1>
                    </div>
                    <label for="drop" class="toggle"><span class="fa fa-bars"></span></label>
                    <input type="checkbox" id="drop" />
                    <ul class="menu mt-lg-3 ml-auto">
                         @can('Admin')
                         <li class="active"><a href="adminpage">Responsable</a></li>
                         @endcan
                        <li><a href="{{ route('affichercour') }}">Cours</a></li>
                        <li><a href="{{ route('afficherformation') }}">Formations</a></li>
                        <li><a href="{{ route('afficherevents') }}">Evenements</a></li>
                        <li>
                            <!-- First Tier Drop Down -->
                            <label for="drop-2" class="toggle"><span class="fa fa-angle-down" aria-hidden="true"></span>
                            </label>
                            <a href="{{ route('afficheaffiche') }}"> <span class="fa fa-angle-down" aria-hidden="true"></span>Affichages</a>
                            
                            
                        </li>
                        <li><a href="{{ route('affichernews') }}">Nouveautés</a></li>
                        <li>
                            @guest
                            <li>
        ...
        <div class="banner-content-w3pvt">
            <div class="banner-w3layouts-info text-center">
                <h3><strong> ISIK </strong>d'une autre façon...<strong>Bienvenue!</strong></h3>
                
                    
                    <button type="submit" class="btn btn-danger btn-lg">Commencer</button>
